...
| AitM (Attacker-in-the-Middle) | アタッカー・イン・ザ・ミドル | [NC-Security §2](NC/NC-Security.md#network-attacks) |
...
| BGPsec | BGPsec | [NC-Security §3c](NC/NC-Security.md#monitoring-detection) |
...
| CIA triad | CIAトライアド（機密性・完全性・可用性） | [NC-Security §1](NC/NC-Security.md#threats-vulnerabilities-countermeasures) |
...
| DDoS (Distributed Denial of Service) | 分散サービス妨害 | [NC-Security §2](NC/NC-Security.md#network-attacks) |
...
| DMZ (Demilitarized Zone) | 非武装地帯 | [NC-Security §3b](NC/NC-Security.md#secure-architectures) |
| DNS (Domain Name System) | ドメインネームシステム | [NC-Applications §1](NC/NC-Applications.md#naming-addressing) |
| DNSSEC | セキュアなDNS | [NC-Security §3b](NC/NC-Security.md#secure-architectures) |
| DPI (Deep Packet Inspection) | ディープパケットインスペクション | [NC-Emerging §1](NC/NC-Emerging.md#middleboxes) |
| DTN (Delay/Disruption Tolerant Networking) | 遅延耐性ネットワーキング | [NC-Mobility §4](NC/NC-Mobility.md#multihop-wireless) |
...
| Firewall | ファイアウォール | [NC-Security §3c](NC/NC-Security.md#monitoring-detection) |
...
| Handoff / Handover | ハンドオフ・ハンドオーバー | [NC-Mobility §1](NC/NC-Mobility.md#cellular) |
...
| IDS (Intrusion Detection System) | 侵入検知システム | [NC-Security §3c](NC/NC-Security.md#monitoring-detection) |
...
| IoT (Internet of Things) | モノのインターネット | [NC-Mobility §3](NC/NC-Mobility.md#device-to-device) |
...
| QKD (Quantum Key Distribution) | 量子鍵配送 | [NC-Emerging §3](NC/NC-Emerging.md#quantum-networking) |
...
| Roaming | ローミング | [NC-Mobility §2](NC/NC-Mobility.md#wlan-mobility) |
...
| RPKI (Resource Public Key Infrastructure) | RPKI | [NC-Security §3c](NC/NC-Security.md#monitoring-detection) |
...
| SDN (Software-Defined Networking) | ソフトウェア定義ネットワーキング | [NC-Emerging §2](NC/NC-Emerging.md#sdn) |
...
| Spoofing | なりすまし | [NC-Security §2](NC/NC-Security.md#network-attacks) |
...
| TLS / SSL | TLS・SSL | [NC-Security §3a](NC/NC-Security.md#cryptography) |
...
| VXLAN | VXLAN | [NC-Emerging §2](NC/NC-Emerging.md#dc-virtualization) |
...
| ZTNA (Zero Trust Network Access) | ゼロトラストネットワークアクセス | [NC-Security §3b](NC/NC-Security.md#secure-architectures) |

## 日本語のみの用語 {#ja}

| 用語 | 定義している節 |
|---|---|
| アドホックネットワーク | [NC-Mobility §4](NC/NC-Mobility.md#multihop-wireless) |
| インテントベースネットワーキング | [NC-Emerging §1](NC/NC-Emerging.md#middleboxes) |
| エイジング | [OS-Scheduling §2](OS/OS-Scheduling.md#policies) |
| 可視光通信 (VLC) | [NC-Emerging §4](NC/NC-Emerging.md#satellite-mmwave-vlc) |
...
| 経路ハイジャック | [NC-Routing §3](NC/NC-Routing.md#bgp)・[NC-Security §2](NC/NC-Security.md#network-attacks) |
...
| 低軌道衛星 (LEO衛星) | [NC-Emerging §4](NC/NC-Emerging.md#satellite-mmwave-vlc) |
...
| トレースバック | [NC-Security §3c](NC/NC-Security.md#monitoring-detection) |
...
| ハニーポット | [NC-Security §3c](NC/NC-Security.md#monitoring-detection) |
...
| ミドルボックス | [NC-Emerging §1](NC/NC-Emerging.md#middleboxes) |
| ミリ波 (mmWave) | [NC-Emerging §4](NC/NC-Emerging.md#satellite-mmwave-vlc) |
| メモリ階層 | [OS-Memory §2](OS/OS-Memory.md#memory-hierarchy) |
| 量子テレポーテーション | [NC-Emerging §3](NC/NC-Emerging.md#quantum-networking) |
